...
# Create a configuration for GPT-2 small
config = GPT2Config(
...
training_args = TrainingArguments(
    output_dir="/mnt/prj/AJ/dock_bert/0521_GPT2/gpt2_small", # The output directory
    overwrite_output_dir=True, # overwrite the content of the output directory
    num_train_epochs=3, # number of training epochs
    per_device_train_batch_size=32, # batch size for training 32
...
# Save the model
model.save_pretrained("/mnt/prj/AJ/dock_bert/0521_GPT2/gpt2_small")
